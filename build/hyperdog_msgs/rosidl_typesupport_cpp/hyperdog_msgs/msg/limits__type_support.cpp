...
static const _Limits_type_support_symbol_names_t _Limits_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hyperdog_msgs, msg, Limits)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, hyperdog_msgs, msg, Limits)),
  }
};
...
{
  return &::hyperdog_msgs::msg::rosidl_typesupport_cpp::Limits_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, hyperdog_msgs, msg, Limits)() {
  return get_message_type_support_handle<hyperdog_msgs::msg::Limits>();
}
